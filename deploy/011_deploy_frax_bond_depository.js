...
module.exports = async ({ getNamedAccounts, deployments }) => {
  ...
  const fraxAddress = await getTokenAddress({ chainId, tokenName: 'usdc', get });
  ...
  await deploy('USDCBondDepository', {
...
module.exports.tags = ['USDCBondDepository', 'AllEnvironments'];